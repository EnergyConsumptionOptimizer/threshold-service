...
describe("ResetThresholdUseCase", () => {
  ...
  it("should reset breached daily thresholds", async () => {
    const t = makeThreshold("t1", ThresholdState.BREACHED, PeriodType.ONE_DAY);
  ...
  it("should reset weekly thresholds only on Monday", async () => {
    ...
    const t = makeThreshold("w1", ThresholdState.BREACHED, PeriodType.ONE_WEEK);
  ...
  it("should NOT reset weekly thresholds on other days", async () => {
    ...
    const t = makeThreshold("w2", ThresholdState.BREACHED, PeriodType.ONE_WEEK);
  ...
  it("should ignore thresholds not in BREACHED state", async () => {
    const t = makeThreshold("ok", ThresholdState.ENABLED, PeriodType.ONE_DAY);
