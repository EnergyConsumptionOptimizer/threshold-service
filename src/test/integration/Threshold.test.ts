...
describe("Threshold", () => {
  ...
  describe("check()", () => {
    ...
    it("should set state to BREACHED when HISTORICAL/FORECAST value is exceeded", () => {
      const threshold = Threshold.create(
        validId,
        validName,
        validUtilityType,
    ...
    it("should remain ENABLED (state must never change) when ACTUAL value is exceeded", () => {
      const threshold = Threshold.create(
        validId,
        validName,
        validUtilityType,
